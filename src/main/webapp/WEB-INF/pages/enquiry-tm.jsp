    ...
    <section class="content">
        <div class="container content-container">
            ...
            <div class="tabs-content tabs-content-2 tab-is-active" id="tab4">
                ...
                <p class="main-info">${NameGroup}</p>
                <p class="current-status">${NameItem}</p>
                    <p class="current-status">${NameSemester}</p>
                <div class="content-wrapper content-wrapper-2">
                    <div class="block">
                        ...
                        <table>
                            ...
                            <с:url var="updateButton" value="http://localhost:8080/enquiry_update_assessments">
                        ...
                        <div class="calculator-box">
                            ...
                            <form:form action="enquiry-tm" modelAttribute="calculator"  method="get">
                                <div class="field-box">
                                ...
                                <input class="btn calc" type="submit" value="Расчитать" onclick="window.location.href='/enquiry-tm'">
                            </form:form>
