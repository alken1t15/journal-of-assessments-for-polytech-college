        ...
        <section class="content">
            <div class="container content-container">
                ...
                <div class="tabs-content tabs-content-2 tab-is-active" id="tab4">
                    <p class="main-info">${numberSemester}</p>
                       ...
                       <div class="block">
                           ...
                           <form:form action="enquiry-m" modelAttribute="semesters"  method="get">
                               <form:select path="semesters">
                                   <form:option value="За 1 семестр" label="1 семестр"/>
                                   <form:option value="За 2 семестр" label="2 семестр"/>
                               </form:select>
                        ...
                        <tr>
                           ...
                           <tr>
                               <td class="main-info">${emp.itemName}</td>
                               <td class="current-status">${emp.monthlyEstimate}</td>
                               <td class="current-status">${emp.creditWork}</td>
                               <td class="current-status">${emp.semesterResult}</td>
                           <tr>
                               </c:forEach>
                        </table>
                               <div class="calculator-box">
                                   <%--@elvariable id="calculator" type="com"--%>
                                   <form:form action="enquiry-m" modelAttribute="calculator"  method="get">
                                       <div class="field-box">
                                           <div class="field-left field-left-no">
                                               <p class="field-left__text  field__text-no">Введите вашу итоговую атестационную оценку</p>
                                           </div>
                                           <div class="field-right">
                                               <form:input type="text" placeholder="Оценка" path="averageMonth" class="input-field-b input-field-1"/>
                                           </div>
                                       </div>
                                       <div class="field-box">
                                           <div class="field-left field-left-no">
                                               <p class="field-left__text field__text-no">Введите вашу оценку за зачетную работу</p>
                                           </div>
                                           <div class="field-right">
                                               <form:input type="text" placeholder="Оценка" path="creditMonth" class="input-field-b input-field-2"/>
                                           </div>
                                       </div>
                                   <input class="btn calc" type="submit" value="Расчитать" onclick="window.location.href='/enquiry-m'">
                                   </form:form>
                                   <p class="result">${resultCalculator}</p>
                                   <p class="red-h"></p>
                               </div>
                       </div>
