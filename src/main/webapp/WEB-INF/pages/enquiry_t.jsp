        ...
        <section class="content">
            <div class="container content-container">
                <div class="tab-header">
                    ...
                    <a href="/enquiry_t" class="tabs__item is-active is-active-a"           data-tab="#tab5">Справки студента</a>
                </div>
                <div class="tabs-content tabs-content-2 tab-is-active" id="tab2">
                    <div class="content-wrapper content-wrapper-2">
                        <div class="content-left">
                            ...
                            <form:form action="/enquiry_t" modelAttribute="studentInfo" method="get">
                                <form:select path="fistLastMiddleName">
                                    <form:options items="${studentInfo.fistLastMiddleNames}"/>
                                </form:select>
                                <input class="btn" type="submit" value="Поиск" onclick="window.location.href='/enquiry_t'">
                            </form:form>
                            <div class="img-box">
